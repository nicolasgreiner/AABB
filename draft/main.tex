...
\preprint{
  \small
  \begin{flushright}
    ZU--TH ??/17\\ CERN-TH-2017-???
  \end{flushright}
}

\abstract{
  $\gamma\gamma bb$ is awesome!
}
...
\hypersetup{
  pdftitle = {Next-to-leading order electroweak corrections to diphoton production in association with two bottom jets},
